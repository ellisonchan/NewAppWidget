...
import com.example.appwidget.databinding.ActivitySplashBinding
import com.example.appwidget.observer.MyLifecycleObserver
import com.example.appwidget.viewmodel.MyViewModel
...
//    }
    ...
    private fun customizeSplashScreenExit() {
        ...
        splashScreen.setOnExitAnimationListener { splashScreenView ->
            ...
            showRenderEffectForSplash(splashScreenView)
...
//            showSplashExitAnimator(splashScreenView)
    ...
    @RequiresApi(31)
    private fun showRenderEffectForSplash(splashScreenView: SplashScreenView) {
        val radiusX = 3f
        val radiusY = 4f
        splashScreenView.setRenderEffect(RenderEffect.createBlurEffect(radiusX, radiusY, Shader.TileMode.CLAMP))
    }
